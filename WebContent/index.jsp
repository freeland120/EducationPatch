...
<title>훈련기관 과정평가 웹 사이트</title>
<link rel="stylesheet" href="./css/bootstrap.css">
<!--웹 디자인 프레임워크 Bootstrap 추가  -->
...
<body>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">
						시큐어 코딩 블록체인 개발과정&nbsp;<small style="color: blue;">(멀티캠퍼스)</small>
					</div>
					...
					<div class="card-body">
						<h5 class="card-title">
							이 멀캠 이과정 최고입니다!!!&nbsp;<small>(2019년 겨울 수강생)</small>
						</h5>
						<p class="card-text">강의가 정말 유익하고 취업 뽀실 수 있을 것 같은 과정입니다~</p>
						<div class="row">
							<div class="col-9 text-left">
								자유도<span style="color: red;">B</span> 강의실력<span
									style="color: red;">A</span> 성취도<span style="color: red;">A</span>
								<span style="color: blue;">(추천:33)</span>
							</div>
							<div class="col-3 text-right">
								<a href="./likeAction.jsp"
									onclick="return confirm('좋아요 하시겠습니까?')">좋아요</a> <a
									href="./hateAction.jsp" onclick="return confirm('나빠요 하시겠습니까?')">싫어요</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">
						오픈API를 활용한 빅데이터 분석과정&nbsp;<small style="color: blue;">(멀티캠퍼스)</small>
					</div>
					<div class="col-4 text-right">
						평가점수<span style="color: red;">A+</span>
					</div>
					<div class="card-body">
						<h5 class="card-title">
							이 멀캠 이과정 최고입니다!!!&nbsp;<small>(2019년 여름 수강생)</small>
						</h5>
						<p class="card-text">강의가 정말 유익하고 취업 뽀실 수 있을 것 같은 과정입니다~</p>
						<div class="row">
							<div class="col-9 text-left">
								자유도<span style="color: red;">C</span> 강의실력<span
									style="color: red;">A</span> 성취도<span style="color: red;">A</span>
								<span style="color: blue;">(추천:19)</span>
							</div>
							<div class="col-3 text-right">
								<a href="./likeAction.jsp"
									onclick="return confirm('좋아요 하시겠습니까?')">좋아요</a> <a
			...
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">
						AI를 활용한 빅데이터 분석&nbsp;<small style="color: blue;">(멀티캠퍼스)</small>
					</div>
					<div class="col-4 text-right">
			...
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">
						파이썬을 활용한 머신러닝&nbsp;<small style="color: blue;">(패스트캠퍼스)</small>
					</div>
					<div class="col-4 text-right">
						평가점수<span style="color: red;">B+</span>
					</div>
					...
					<form action="./evaluationRegisterAction.jsp" method="post">
						<div class="form-row">
							<div class="form-group col-sm-6">
								<label>과정명</label> <input type="text" name="lectureName"
									class="form-control" maxlength="20">
							</div>

							<div class="form-group col-sm-6">
								<label>강사명</label> <input type="text" name="professorName"
									class="form-control" maxlength="20">
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-4">
								<label>수강 기수</label> <select name="semesterDivide"
									class="form-control">
							...
							<div class="form-group col-sm-4">
								<label>분야</label> <select name="lectureDivide"
									class="form-control">
						...
						<div class="form-row">
							<div class="form-group col-sm-4">
								<label>후기점수</label> <select name="totalScore"
									class="form-control">
							...
							<div class="form-group col-sm-4">
								<label>강사 강의력</label> <select name="lectureSkill"
									class="form-control">
							...
							<div class="form-group col-sm-4">
								<label>주로 나오는 간식</label> <select name="Snack"
									class="form-control">
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2020 유덕경 </footer>
